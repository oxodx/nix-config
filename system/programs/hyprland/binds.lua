...
local qsScripts = homeDir .. "/.config/quickshell/scripts"
...
hl.bind("SHIFT + SUPER + ALT + Slash",
	hl.dsp.exec_cmd("qs -p " .. homeDir .. "/.config/quickshell/welcome.qml"))
...
hl.bind("SUPER + Period", hl.dsp.exec_cmd(
		qsIsAlive .. " || pkill fuzzel || " .. qsScripts .. "/hypr/fuzzel-emoji.sh copy"),
...
hl.bind("SUPER + SHIFT + A",
	hl.dsp.exec_cmd(qsIsAlive .. " || pidof slurp || " .. qsScripts .. "/hypr/snip_to_search.sh"))
--# OCR
...
--# AI
hl.bind("SUPER + SHIFT + ALT + mouse:273", hl.dsp.exec_cmd(qsScripts .. "/hypr/ai/primary-buffer-query.sh"),
