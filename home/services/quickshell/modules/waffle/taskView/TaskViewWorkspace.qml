...
WMouseAreaButton {
  ...
  ColumnLayout {
    ...
    WText {
      ...
      text: root.newWorkspace ? Translation.tr("New desktop") : Translation.tr("Desktop %1").arg(
                                  root.workspace)
    }
        ...
        sourceComponent: StyledImage {
          ...
          Repeater {
            ...
            delegate: ScreencopyView {
              ...
              readonly property var hyprlandWindowData: HyprlandData.windowByAddress[`0x
${modelData.HyprlandToplevel?.address}`]
