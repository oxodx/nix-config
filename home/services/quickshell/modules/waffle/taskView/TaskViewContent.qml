        ...
        delegate: Item {
          ...
          TaskViewWindow {
            ...
            property int mappedY: {
              ...
              var rootPosToThis = -(clientRow.y + windowListView.y + root.padding
                                    + windowItem.titleBarImplicitHeight);
            ...
            DragHandler {
              ...
              onActiveChanged: {
                if (active) {
                  ...
                  if (root.hoveredWorkspace !== null && root.hoveredWorkspace.workspace
                      !== windowItem.hyprlandClient.workspace.id) {
                    Hyprland.dispatch(`hl.dsp.window.move({ workspace = ${root.hoveredWorkspace.workspace}, follow = false, window = "address:
${windowItem.hyprlandClient.address}" })`);
                  } else {
