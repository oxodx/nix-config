      ...
      for (let c = 0; c < categoriesArray.length; c++) {
        ...
        for (let i = 0; i < allResults.length; i++) {
          if (allResults[i].type === category) {
            ...
            tweakedEntry.category = categorizedResults.length === 0 ? Translation.tr("Best match") :
                                                                      entry.type;
      ...
      WListView {
        ...
        model: {
          ...
          var result = [searchResultComp.createObject(null, {
                                                        ...
                                                        iconName: isAppEntry ? "open_in_new" :
                                                                               "keyboard_return",
                                                      ...
                                                      }), ...(isAppEntry ? [searchResultComp.createObject(null,
                                                                                                          {
                                                                                                            name: startPinned
                                                                                                                  ? Translation.tr(
                                                                                                                    ...
                                                                                                                    Translation.tr(
                                                                                                                      "Pin to Start"),
                                                                                                            iconName: startPinned
                                                                                                                      ? "keep_off" :
                                                                                                                        "keep",
                                                                                                            iconType: LauncherSearchResult.IconType.Material,
                                                                                                            execute: (
                                                                                                                       ) => {
                                                                                                                         LauncherApps.togglePin(
                                                                                                                               appId);
                                                                                                                       }
                                                                                                          })] : []),
                        ...(isAppEntry ? [searchResultComp.createObject(null, {
                                                                          name: pinned ? Translation.tr(
                                                                                           "Unpin from taskbar") :
                                                                                         Translation.tr(
                                                                                           "Pin to taskbar"),
                                                                          iconName: pinned ? "keep_off" :
                                                                                             "keep",
                                                                          iconType: LauncherSearchResult.IconType.Material,
                                                                          execute: () => {
