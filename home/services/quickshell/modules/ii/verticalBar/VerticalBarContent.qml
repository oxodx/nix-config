  ...
  FocusedScrollMouseArea { // Top section | scroll to change brightness
    ...
    ColumnLayout { // Content
      ...
      Bar.LeftSidebarButton { // Left sidebar button
        ...
        Layout.topMargin: (Appearance.sizes.baseVerticalBarWidth - implicitWidth) / 2
                          + Appearance.sizes.hyprlandGapsOut
        colBackground: barTopSectionMouseArea.hovered ? Appearance.colors.colLayer1Hover :
  ...
  FocusedScrollMouseArea { // Bottom section | scroll to change volume
    ...
    ColumnLayout {
      ...
      RippleButton { // Right sidebar button
        ...
        colBackground: barBottomSectionMouseArea.hovered ? Appearance.colors.colLayer1Hover :
                                                           ColorUtils.transparentize(
                                                             Appearance.colors.colLayer1Hover, 1)
        ...
        ColumnLayout {
          ...
          MaterialSymbol {
            ...
            text: BluetoothStatus.connected ? "bluetooth_connected" : BluetoothStatus.enabled ? "bluetooth" :
                                                                                                "bluetooth_disabled"
            iconSize: Appearance.font.pixelSize.larger
            color: rightSidebarButton.colText
          }
