...
RippleButton {
  ...
  colBackground: (root.down || root.keyboardDown) ? Appearance.colors.colPrimaryContainerActive : (selected
  ...
  property color colForeground: selected ? Appearance.colors.colOnPrimaryContainer :
