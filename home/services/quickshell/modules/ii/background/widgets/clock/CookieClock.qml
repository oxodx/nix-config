...
Item {
  ...
  property color colBackgroundInfo: ColorUtils.mix(Appearance.colors.colPrimary,
  ...
  FadeLoader {
    ...
    shown: Config.options.time.secondPrecision
  ...
  FadeLoader {
    ...
    sourceComponent: Rectangle {
      color: Config.options.background.widgets.clock.cookie.minuteHandStyle === "medium" ? root.colBackground :
                                                                                           root.colMinuteHand
      implicitWidth: 6
