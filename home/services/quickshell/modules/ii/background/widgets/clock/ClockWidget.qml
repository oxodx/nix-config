...
AbstractBackgroundWidget {
  ...
  readonly property string clockStyle: GlobalStates.screenLocked
  ...
  component StatusRow: Item {
    ...
    Rectangle {
      ...
      color: ColorUtils.transparentize(Appearance.colors.colSecondaryContainer, root.clockStyle === "cookie"
                                       ? 0 : 1)
  ...
  component ClockStatusText: Row {
    ...
    property color textColor: root.clockStyle === "cookie" ? Appearance.colors.colOnSecondaryContainer :
                                                             root.colText
