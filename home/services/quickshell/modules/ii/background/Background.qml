...
readonly property bool verticalParallax: (Config.options.background.parallax.autoVertical && wallpaperHeight
                                          > wallpaperWidth) || Config.options.background.parallax.vertical
// Colors
...
property color colText: {
  ...
  return (GlobalStates.screenLocked && shouldBlur) ? Appearance.colors.colOnLayer0 :
                                                     CF.ColorUtils.colorWithLightness(
                                                       Appearance.colors.colPrimary, (dominantColorIsDark
                                                                                      ? 0.8 : 0.12));
}
Behavior on colText {
  ...
  StyledImage {
    ...
    property real usedFractionX: {
      ...
      if (Config.options.background.parallax.enableSidebar) {
        ...
        usedFraction += (sidebarFraction * GlobalStates.sidebarRightOpen - sidebarFraction
