...
RippleButton {
  ...
  colBackground: menuEntry.isSeparator ? Appearance.m3colors.m3outlineVariant : ColorUtils.transparentize(
  ...
  contentItem: RowLayout {
    ...
    Item {
      ...
      Loader {
        anchors.fill: parent
        active: root.menuEntry.buttonType === QsMenuButtonType.CheckBox && root.menuEntry.checkState
                !== Qt.Unchecked
