  ...
  RowLayout {
    ...
    Loader {
      ...
      sourceComponent: CircleUtilButton {
        ...
        onClicked: Quickshell.execDetached(["qs", "-p", Quickshell.shellPath(""), "ipc", "call", "region",
                                            "screenshot"])
        MaterialSymbol {
      ...
      sourceComponent: CircleUtilButton {
        ...
        onClicked: event => {
          if (PowerProfiles.hasPerformanceProfile) {
            ...
            PowerProfiles.profile = PowerProfiles.profile == PowerProfile.Balanced ? PowerProfile.PowerSaver :
