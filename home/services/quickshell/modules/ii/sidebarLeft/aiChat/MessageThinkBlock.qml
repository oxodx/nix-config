...
Item {
  ...
  property var collapseAnimation: messageTextBlock.implicitHeight > 40
    ...
    Rectangle { // Header background
      ...
      RowLayout { // Header content
        ...
        StyledText {
          ...
          text: root.completed ? Translation.tr("Thought") : (Translation.tr("Thinking") + ".".repeat(Math.random(
                                                                                                        ) * 4))
        }
        Item {
          Layout.fillWidth: true
