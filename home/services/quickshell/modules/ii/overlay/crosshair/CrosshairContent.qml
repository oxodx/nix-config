...
Item {
  ...
  "c;0;u;FFFFFF;h;1;o;0.5;t;1;d;0;a;1;z;2;0a;0.8;0l;6;0v;6;0g;0;0t;2;0o;3;1b;1;1a;0.35;1l;2;1v;2;1g;0;1t;2;1o;10"
  ...
  implicitWidth: Math.max(centerDotTotalSize, innerLineTotalSize, outerLineTotalSize)
                 + 2 // 2 for pixel correction
  ...
  Repeater {
    ...
    Item {
      ...
      property int hairLength: (innerHair.index % 2 === 0 ? root.innerLineLength :
                                                            root.innerLineVerticalLength)
  ...
  Repeater {
    ...
    Item {
      ...
      property int hairLength: (outerHair.index % 2 === 0 ? root.outerLineLength :
                                                            root.outerLineVerticalLength)
