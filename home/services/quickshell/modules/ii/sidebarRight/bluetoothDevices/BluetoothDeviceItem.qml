  ...
  contentItem: ColumnLayout {
    ...
    RowLayout {
      ...
      ActionButton {
        ...
        colBackground: p ? Appearance.colors.colError : ColorUtils.transparentize(Appearance.colors.colLayer3,
                                                                                  1)
        colBackgroundHover: p ? Appearance.colors.colErrorHover : ColorUtils.transparentize(
