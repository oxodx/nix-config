...
ComboBox {
  ...
  background: Rectangle {
    ...
    color: (root.down && !root.popup.visible) ? root.colBackgroundActive : root.hovered ? root.colBackgroundHover :
                                                                                          root.colBackground
  ...
  contentItem: Item {
    ...
    RowLayout {
      ...
      Loader {
        ...
        active: root.buttonIcon.length > 0 || (root.currentIndex >= 0 && typeof root.model[root.currentIndex]
                                               === 'object' && root.model[root.currentIndex]?.icon)
        visible: active
        sourceComponent: MaterialSymbol {
          text: {
            if (root.currentIndex >= 0 && typeof root.model[root.currentIndex] === 'object'
  ...
  delegate: ItemDelegate {
    ...
    property color colText: (root.currentIndex === itemDelegate.index)
