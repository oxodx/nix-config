{
  ...
  mkNginxVirtualHost = {
    ...
    themeParkTag =
      if themeParkService == null
      then "</body>"
      else themeParkTags.${themeParkService} or "</body>";
  ...
  mkCaddyVirtualHost = {
    ...
    reverseProxyBlock =
      if subdirectives == []
      then "reverse_proxy ${reverseProxyMatcher}"
      else ''
